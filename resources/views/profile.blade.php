              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      @if(Auth::user()->profil=='admin')
                        <form action="{{route('update_user_admin')}}" method="POST">
                          @csrf
                          @method('PUT')
                          <div class="row">
                            ...
                            <input type="hidden" id="identifiant_user" name="identifiant_user" value="{{Auth::user()->id}}">
                            <div class="mb-3 col-md-6">
                      ...
                      <form action="#" method="POST">
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              <label for="lastName" class="form-label">Nom</label>
                              <input class="form-control" type="text" disabled name="nom_user" id="nom_user" value="{{Auth::user()->nom}}" />
                            </div>
                            <div class="mb-3 col-md-6">
                              <label for="organization" class="form-label">Username</label>
                              <input
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form action="{{ route('password.update_profile') }}" method="POST" id="update_password_user">
                        @csrf
                        @method('PUT')
                        <input
                              class="form-control"
